    ...
    export default{
        ...
        methods: {
            search: function () {
                ...
                Indicator.open();
                // 'http://192.168.1.101/MyApi/Public/demo/?service=Eleme.search&keyword='+this.keyword+'&search_type=restaurants'
                this.$http.jsonp('http://192.168.1.101/MyApi/Public/demo/?service=Eleme.getShops&offset=0&limit=10',).then(function (res) {
